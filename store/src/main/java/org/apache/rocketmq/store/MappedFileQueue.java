 ...
 * MappedFileQueue是MappedFile的管理容器，使用CopyOnWriteArrayList来管理所有的MappedFile。
 * MappedFileQueue提供查找目录下MappedFile的方法
 * <p>
 * 1.MappedFile组成的队列
...
public class MappedFileQueue {
     ...
     * 而是返回MappedFile的getFileFormOffset()方法
     *
     * @return 最小偏移量
     */
    ...
    /**
     * 还有多少字节等待commit的(write与commit位置之差)
     */
     ...
     * 如果不将已消费的消息从存储文件中删除，会造成极大的内存压力与资源浪费，所以RocketMQ采取定时删除存储文件的策略。也就是说，在存储文件中，

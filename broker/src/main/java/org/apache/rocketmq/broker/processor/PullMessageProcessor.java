...
public class PullMessageProcessor extends AsyncNettyRequestProcessor {
     ...
     * @param channel
     * @param request
     * @param brokerAllowSuspend if true 表示允许 broker 挂起请求
     * @return
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request, boolean brokerAllowSuspend) throws RemotingCommandException {
         ...
         * 2. 同时也可以设置客户端的发布、订阅权限，细节度控制访问权限
         * DENY(拒绝)、ANY(PUB 或者 SUB 权限)、PUB(发送权限)、SUB(订阅权限)等权限
         */
        ...
        if (getMessageResult != null) {
            ...
            switch (response.getCode()) {
                ...
                case ResponseCode.SUCCESS:
                    ...
                    break;
                case ResponseCode.PULL_NOT_FOUND: // 未找到满足条件的消息
                    // 如果支持挂起，就挂起当前请求
